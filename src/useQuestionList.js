    ...
    },
    {
      ...
      groupContents: [
        ...
        },
        {
          ...
          choices: [
            '舌の運動は、舌下神経支配である',
            '舌の前2/3の味覚は、三叉神経支配である。',
            '嚥下の咽頭相では、軟口蓋が後上方へ移動し、喉頭後壁と接触する。',
          ],
          answerImg: [swallowing],
          answer:
            '舌の運動は、舌下神経支配である / 嚥下の咽頭相では、軟口蓋が後上方へ移動し、喉頭後壁と接触する。',
          commentary:
            '舌の前2/3の味覚は、顔面神経支配であり、後1/3の味覚は、舌咽神経支配。舌の痛覚は三叉神経支配である。',
        },
        {
          detailInfo: '',
          questionImg: [],
          questionSentence:
            '正しい選択肢を選べ（複数選択可/すべて誤りの場合もある）',
          choices: [
            'タンパク質の分解に関与するエンテロキナーゼは、膜消化酵素である',
            '膜消化酵素のラクターゼは、ラクトースをグルコースとフルクトースに分解する',
            '管腔内消化酵素のコリパーゼは、胆汁酸存在下で膵リパーゼを油滴に結合させる。',
          ],
          answerImg: [lipidSynthesize],
          answer:
            'タンパク質の分解に関与するエンテロキナーゼは、膜消化酵素である / 管腔内消化酵素のコリパーゼは、胆汁酸存在下で膵リパーゼを油滴に結合させる。',
          commentary: 'ラクターゼはグルコースとガラクトースに分解される。',
        },
        {
          detailInfo: '',
          questionImg: [],
          questionSentence:
            '正しい選択肢を選べ（複数選択可/すべて誤りの場合もある）',
          choices: [
            'ビタミンB₁は糖代謝に関与する。欠乏すると脚気になる',
            '亜鉛はSODやDNAポリメラーゼの構成成分である。欠乏すると創傷治癒遅延が生じる',
            'ビタミンEは生体内抗酸化作用を有す。欠乏すると壊血病になる。',
          ],
          answerImg: [],
          answer:
            'ビタミンB₁は糖代謝に関与する。欠乏すると脚気になる / 亜鉛はSODやDNAポリメラーゼの構成成分である。欠乏すると創傷治癒遅延が生じる',
          commentary:
            'ビタミンEが欠乏すると溶血性貧血になる。ビタミンCが生体内抗酸化作用を有す。',
        },
        {
          detailInfo: '',
          questionImg: [],
          ...
          choices: [
            '胆汁酸は、主に小腸中部で吸収される',
            'ビタミンB12以外の水溶性および脂溶性ビタミンは主に小腸下部で吸収される',
            'Ca²⁺やFe²⁺は主に小腸下部で吸収される',
          ],
          answerImg: [vitaminB12],
          answer: 'すべて誤り',
          commentary:
            '胆汁酸は主に小腸下部、B12以外のビタミンは主に小腸上部、Ca²⁺Fe²⁺は主に小腸上部で吸収される。',
        },
        {
          detailInfo: '',
          questionImg: [],
          questionSentence:
            '正しい選択肢を選べ（複数選択可/すべて誤りの場合もある）',
          choices: [
            '体温調節中枢は視床下部に存在する。冷ニューロンは高温を感知し、身体を冷やす指令を出す',
            '深部体温は、起床直後に最も低くなる',
            '血中メラトニン値には日内変動があり、起床直後に最も高い値を示す',
          ],
          answerImg: [],
          answer: 'すべて誤り',
          commentary:
