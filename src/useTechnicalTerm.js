...
export const useTechnicalTerm = () => {
  const [technicalTerm, setTechnicalTerm] = useState([
    ...
    {
      term: ['心房細動', 'ventricular fibrillation'],
      explanation:
    ...
    {
      term: ['上室性頻拍', 'supraventricular tachycardia', '発作性上室性頻拍'],
      explanation:
    ...
    },
    {
      ...
      explanation:
        'プルキンエ線維の右脚だけが遮断され、右心室筋の興奮が左に比べて遅れる→QRS波の幅が広く（3目盛り以上だと完全右脚ブロックと呼ばれる）、V₁誘導で大きな+のR’波が観測される。',
    },
    // {
    //   term:[''],
    //   explanation:'',
